...
export default function Services() {
    ...
    const services = [
        {
            title: 'Siri Market',
            desc: 'A revolutionary e-commerce platform that allows you to buy and resell goods anywhere, even without holding stock.',
            icon: '🛍️',
            url: '/siri',
        ...
        {
            title: 'Rise Network',
            desc: 'Connect with professionals, find freelance work, jobs, and internships, and grow your career network.',
            icon: '📈',
            url: '/rise',
