                        ...
                        <nav className="space-y-4">
                            {[
                                ...
                                <a
                                    ...
                                    className="block text-base lg:text-lg hover:text-white transition-colors"
                                    style={{ color: '#9ca3af' }}
                                >
                                    {item.name}
                                </a>
                    ...
                    <div>
                        ...
                        <nav className="space-y-4">
                            {[
                                ...
                                <a key={item.name} href="#" onClick={(e) => { e.preventDefault(); navigate(item.url); }} className="block text-base lg:text-lg hover:text-white transition-colors" style={{ color: '#9ca3af' }}>
                                    {item.name}
                                </a>
                            ))}
                        </nav>
