        ...
        <div className="min-h-screen py-24 px-6">
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                    <div>
                        ...
                        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                            The future of retail is here. Become a trader without owning stock. Buy goods online and resell them effortlessly, empowering anyone to start a business from their phone.
                        </p>
                        <div className="flex gap-4">
                            <button className="px-8 py-4 rounded-full bg-blue-600 text-white font-bold hover:bg-blue-500 transition-colors">
                                Start Selling
                            </button>
                            <button className="px-8 py-4 rounded-full border border-gray-600 text-white font-bold hover:bg-gray-800 transition-colors">
                                Learn More
                            </button>
                        </div>
                    </div>
                ...
                <div className="text-center rounded-3xl bg-gradient-to-r from-blue-900/50 to-cyan-900/50 p-16 border border-blue-500/30">
                    ...
                    <button className="px-10 py-4 rounded-full bg-white text-blue-900 font-bold hover:shadow-lg hover:scale-105 transition-all">
                        Download App
                    </button>
                </div>
            </div>
