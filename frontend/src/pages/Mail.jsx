        ...
        <div className="min-h-screen py-24 px-6 flex items-center justify-center">
            <div className="max-w-md w-full bg-gray-800 p-8 rounded-3xl border border-gray-700 shadow-2xl">
                ...
                <form className="space-y-6">
                    ...
                    <div className="flex items-center gap-2 mb-6 bg-yellow-500/10 p-3 rounded-lg border border-yellow-500/20 text-yellow-500 text-sm">
                        <span>⚠️ This is a restricted area. Authorized personnel only.</span>
                    </div>
                    <button onClick={(e) => { e.preventDefault(); navigate('/coming-soon'); }} className="w-full py-3 rounded-xl bg-red-600 text-white font-bold hover:bg-red-500 transition-colors">
                        Sign In
                    </button>
                </form>
