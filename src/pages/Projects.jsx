                    ...
                    {[
                        {
                            ...
                            desc: 'A cross-platform mobile application enabling users to buy and resell goods with zero inventory. Features include real-time inventory tracking, secure payments, and profit analytics.',
                            image: '🛍️',
                            color: 'blue'
                        },
                        {
                            ...
                            desc: 'A comprehensive networking platform connecting freelancers with businesses. Includes job boards, profile management, and messaging systems.',
                            image: '📈',
                            color: 'purple'
                        },
                        {
                        ...
                        <div key={i} className={`flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                            ...
                            <div className="flex-1">
                                ...
                                <button className="text-white font-bold text-lg hover:underline decoration-2 underline-offset-4 decoration-blue-500">
                                    View Case Study
                                </button>
                            </div>
                        </div>
