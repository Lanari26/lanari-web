            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                            A powerful platform connecting professionals, freelancers, and businesses. Find work, showcase your skills, and build your network in one place.
                        </p>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-24">
                    ...
                    <div className="p-8 rounded-3xl bg-gray-800/40 border border-gray-700">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-4">Freelance</h3>
                        <p className="text-gray-400">
                            Access a vast marketplace of freelance opportunities. From coding to design, find projects that match your skills.
                        </p>
                    </div>
                    <div className="p-8 rounded-3xl bg-gray-800/40 border border-gray-700">
