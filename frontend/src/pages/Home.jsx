        ...
        <div className="relative">
            ...
            <section className="relative h-screen flex flex-col items-center justify-center px-6">
                ...
                <div className="w-full max-w-[90%] lg:max-w-[80%]">
                    <form onSubmit={(e) => { e.preventDefault(); if (searchQuery.trim()) navigate(`/search?q=${encodeURIComponent(searchQuery)}`); }} className="rounded-full px-4 py-3 md:px-6 md:py-5 flex items-center gap-2 md:gap-4 shadow-2xl transition-all hover:shadow-3xl" style={{ backgroundColor: '#1f2937', border: '1px solid #4b5563' }}>
                        ...
                        <input
                            ...
                            style={{ color: '#ffffff' }}
                        />
                        <button type="button" onClick={() => navigate('/coming-soon')} className="p-1.5 md:p-2 rounded-full transition-colors hover:bg-gray-700 flex-shrink-0">
                            <svg className="w-5 h-5 md:w-6 md:h-6" style={{ color: '#d1d5db' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                            </svg>
                        </button>
                        <button type="button" onClick={() => navigate(`/ai${searchQuery.trim() ? `?q=${encodeURIComponent(searchQuery)}` : ''}`)} className="px-3 py-1.5 md:px-5 md:py-2.5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full text-sm md:text-base lg:text-lg font-bold text-white hover:shadow-lg hover:shadow-purple-500/50 transition-all flex-shrink-0 whitespace-nowrap">
                            AI Mode
                        </button>
                    </form>
                        ...
                        {[
                            {
                                icon: '🛍️',
                                title: 'Siri',
                                desc: 'Buy & resell anywhere even without stock',
                            ...
                            },
                            {
                                icon: '🚀',
                                title: 'Rise',
                                desc: 'Freelancing, Jobs & Internships',
                        ...
                        {[
                            {
                                icon: '🛍️',
                                title: 'Siri Market',
                                desc: 'Become a trader or seller anywhere even without physical stock. Buy goods online and resell them easily, allowing anyone to shop from wherever they are.',
                            ...
                            },
                            {
                                icon: '',
                                title: 'Rise Network',
                                desc: 'Enables communication, networking, freelancing, and access to online job and internship opportunities. Connect with professionals and grow your career.',
