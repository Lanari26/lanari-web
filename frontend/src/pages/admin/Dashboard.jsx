...
const statCards = [
    ...
    { key: 'teamMembers', label: 'Team Members', badge: 'pendingReports', badgeLabel: 'reports to review', icon: 'M18 9a3 3 0 11-6 0 3 3 0 016 0zM6 10a2 2 0 100-4 2 2 0 000 4zm12 10a4 4 0 00-8 0m8 0h4m-4 0a4 4 0 00-8 0m-6 0a4 4 0 018 0', color: 'from-cyan-500 to-blue-400', link: '/admin/team' },
    { key: 'internships', label: 'Internships', badge: 'newInternshipApplications', badgeLabel: 'new', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253', color: 'from-violet-500 to-purple-400', link: '/admin/internships' },
];
