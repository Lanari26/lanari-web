            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
                    {[
                        ...
                        <div key={i} className="group p-8 rounded-3xl bg-gray-800/40 border border-gray-700 hover:border-emerald-500/50 transition-all hover:-translate-y-2 cursor-pointer">
                ...
                <div className="bg-emerald-900/20 border border-emerald-500/20 rounded-3xl p-12 text-center">
                    ...
                    <button className="px-8 py-4 rounded-full bg-emerald-600 text-white font-bold hover:bg-emerald-500 transition-colors">
                        Browse Free Courses
                    </button>
                </div>
            </div>
