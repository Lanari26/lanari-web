            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="grid md:grid-cols-2 gap-8 text-left mb-16">
                    <div className="p-8 rounded-3xl bg-gray-800/40 border border-gray-700">
                        ...
                        <button onClick={() => navigate('/coming-soon')} className="text-white font-bold border-b border-pink-400 hover:text-pink-400 transition-colors">Learn More</button>
                    </div>
                    <div className="p-8 rounded-3xl bg-gray-800/40 border border-gray-700">
                ...
                <div className="bg-gray-800 p-8 rounded-3xl">
                    ...
                    <form className="max-w-md mx-auto space-y-4">
                        ...
                        <button type="button" onClick={() => navigate('/coming-soon')} className="w-full py-3 rounded-xl bg-pink-600 text-white font-bold hover:bg-pink-500">Submit Proposal</button>
                    </form>
                </div>
            </div>
        </div>
